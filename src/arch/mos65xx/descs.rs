...
fn direct_r (a: u64) -> Operand { Operand::Mem(VA(a), R) }
fn direct_w (a: u64) -> Operand { Operand::Mem(VA(a), W) }
fn direct_rw(a: u64) -> Operand { Operand::Mem(VA(a), RW) }
fn target   (a: u64) -> Operand { Operand::Mem(VA(a), Target) }
...
const INST_DESCS: &[InstDesc] = &[
	...
	InstDesc { opcode: HLT_02,  meta_op: HLT,  addr_mode: IMP, access: None },
	OP_INVALID,
	...
	InstDesc { opcode: HLT_12,  meta_op: HLT,  addr_mode: IMP, access: None },
	OP_INVALID,
	...
	InstDesc { opcode: HLT_22,  meta_op: HLT,  addr_mode: IMP, access: None },
	OP_INVALID,
	...
	InstDesc { opcode: HLT_32,  meta_op: HLT,  addr_mode: IMP, access: None },
	OP_INVALID,
	...
	InstDesc { opcode: HLT_42,  meta_op: HLT,  addr_mode: IMP, access: None },
	OP_INVALID,
	...
	InstDesc { opcode: HLT_52,  meta_op: HLT,  addr_mode: IMP, access: None },
	OP_INVALID,
	...
	InstDesc { opcode: HLT_62,  meta_op: HLT,  addr_mode: IMP, access: None },
	OP_INVALID,
	...
	InstDesc { opcode: HLT_72,  meta_op: HLT,  addr_mode: IMP, access: None },
	OP_INVALID,
	...
	InstDesc { opcode: HLT_B2,  meta_op: HLT,  addr_mode: IMP, access: None },
	OP_INVALID,
	...
	InstDesc { opcode: HLT_D2,  meta_op: HLT,  addr_mode: IMP, access: None },
	OP_INVALID,
	...
	InstDesc { opcode: HLT_F2,  meta_op: HLT,  addr_mode: IMP, access: None },
	OP_INVALID,
