...
fn span_map() {
	...
	assert_eq!(m.iter().collect::<Vec<_>>(), &[
		Span { start: 0x0000, end: 0x10000,  kind: Unk },
	]);
	...
	assert_eq!(m.iter().collect::<Vec<_>>(), &[
		Span { start: 0x0000, end: 0x1000,  kind: Unk  },
		Span { start: 0x1000, end: 0x2000,  kind: Data },
		Span { start: 0x2000, end: 0x10000, kind: Unk  }
	]);
	...
	assert_eq!(m.iter().collect::<Vec<_>>(), &[
		Span { start: 0x0000, end: 0x1000,  kind: Unk  },
		Span { start: 0x1000, end: 0x2000,  kind: Data },
		Span { start: 0x2000, end: 0x10000, kind: Data }
	]);
	...
	assert_eq!(m.iter().collect::<Vec<_>>(), &[
		Span { start: 0x0000, end: 0x1000,  kind: Data },
		Span { start: 0x1000, end: 0x10000, kind: Unk  },
	]);
	...
	assert_eq!(m.iter().collect::<Vec<_>>(), &[
		Span { start: 0x0000, end: 0x1000,  kind: Data },
		Span { start: 0x1000, end: 0xF000,  kind: Unk  },
		Span { start: 0xF000, end: 0x10000, kind: Data }
	]);
	...
	assert_eq!(m.iter().collect::<Vec<_>>(), &[
		Span { start: 0x0000, end: 0x1000,  kind: Data },
		Span { start: 0x1000, end: 0x2000,  kind: Data },
		Span { start: 0x2000, end: 0xF000,  kind: Unk  },
		Span { start: 0xF000, end: 0x10000, kind: Data }
	]);
	...
	assert_eq!(m.iter().collect::<Vec<_>>(), &[
		Span { start: 0x0000, end: 0x1000,  kind: Data },
		Span { start: 0x1000, end: 0x2000,  kind: Data },
		Span { start: 0x2000, end: 0xE000,  kind: Unk  },
		Span { start: 0xE000, end: 0xF000,  kind: Data },
		Span { start: 0xF000, end: 0x10000, kind: Data }
	]);
	...
	assert_eq!(m.iter().collect::<Vec<_>>(), &[
		...
		Span { start: 0x2000, end: 0xE000,  kind: Unk  },
		Span { start: 0xE000, end: 0xF000,  kind: Data },
		Span { start: 0xF000, end: 0x10000, kind: Unk }
	]);
	...
	assert_eq!(m.iter().collect::<Vec<_>>(), &[
		Span { start: 0x0000, end: 0x1000,  kind: Unk },
		Span { start: 0x1000, end: 0x2000,  kind: Data },
		Span { start: 0x2000, end: 0xE000,  kind: Data  },
		Span { start: 0xE000, end: 0xF000,  kind: Data },
		Span { start: 0xF000, end: 0x10000, kind: Unk }
	]);
	...
	assert_eq!(m.iter().collect::<Vec<_>>(), &[
		Span { start: 0x0000, end: 0x2000,  kind: Unk },
		Span { start: 0x2000, end: 0xE000,  kind: Data  },
		Span { start: 0xE000, end: 0xF000,  kind: Data },
		Span { start: 0xF000, end: 0x10000, kind: Unk }
	]);
	...
	assert_eq!(m.iter().collect::<Vec<_>>(), &[
		Span { start: 0x0000, end: 0x2000,  kind: Unk },
		Span { start: 0x2000, end: 0xE000,  kind: Data  },
		Span { start: 0xE000, end: 0x10000, kind: Unk },
	]);
