...
impl IrBuilder {
	/// TODO: docme
	pub(crate) fn nop(&mut self, ea: EA) {
		self.inst(IrInst::nop(ea));
	}

	/// TODO: docme
	pub(crate) fn use_(&mut self, ea: EA, reg: IrReg) {
	...
	/// TODO: docme
	pub(crate) fn branch(&mut self, ea: EA, target: EA, targetn: i8) {
	...
	/// TODO: docme
	pub(crate) fn ibranch(&mut self, ea: EA, target: impl Into<IrSrc>, targetn: i8) {
		self.inst(IrInst::ibranch(ea, target.into(), targetn));
	}

	/// TODO: docme
	pub(crate) fn call(&mut self, ea: EA, target: EA, targetn: i8) {
		self.inst(IrInst::call(ea, target, targetn));
	}

	/// TODO: docme
	pub(crate) fn icall(&mut self, ea: EA, target: impl Into<IrSrc>, targetn: i8) {
		self.inst(IrInst::icall(ea, target.into(), targetn));
	}

	/// TODO: docme
	pub(crate) fn ret(&mut self, ea: EA, target: impl Into<IrSrc>, targetn: i8) {
