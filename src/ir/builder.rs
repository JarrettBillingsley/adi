...
impl IrBuilder {
	/// TODO: docme
	pub(crate) fn nop(&mut self, ea: EA) -> &mut Self {
		self.inst(IrInst::nop(ea))
	}

	/// TODO: docme
	pub(crate) fn use_(&mut self, ea: EA, reg: IrReg) -> &mut Self {
	...
	/// TODO: docme
	pub(crate) fn ilo(&mut self, ea: EA, dst: IrReg, src: impl Into<IrSrc>,
		dstn: i8, srcn: i8) -> &mut Self {
		self.inst(IrInst::ilo(ea, dst, src.into(), dstn, srcn))
	}

	/// TODO: docme
	pub(crate) fn ihi(&mut self, ea: EA, dst: IrReg, src: impl Into<IrSrc>,
		dstn: i8, srcn: i8) -> &mut Self {
		self.inst(IrInst::ihi(ea, dst, src.into(), dstn, srcn))
	}
	...
	/// TODO: docme
	pub(crate) fn ibset(&mut self, ea: EA, dst: IrReg, src1: impl Into<IrSrc>,
		src2: impl Into<IrSrc>, src3: impl Into<IrSrc>,
		dstn: i8, src1n: i8, src2n: i8, src3n: i8) -> &mut Self {
		self.inst(IrInst::ibset(ea, dst, src1.into(), src2.into(), src3.into(),
			dstn, src1n, src2n, src3n))
	}
	...
	/// TODO: docme
	pub(crate) fn branch(&mut self, ea: EA, target: EA, targetn: i8) -> &mut Self {
	...
	/// TODO: docme
	pub(crate) fn ibranch(&mut self, ea: EA, target: impl Into<IrSrc>, targetn: i8) -> &mut Self {
		self.inst(IrInst::ibranch(ea, target.into(), targetn))
	}

	/// TODO: docme
	pub(crate) fn call(&mut self, ea: EA, target: EA, targetn: i8) -> &mut Self {
		self.inst(IrInst::call(ea, target, targetn))
	}

	/// TODO: docme
	pub(crate) fn icall(&mut self, ea: EA, target: impl Into<IrSrc>, targetn: i8) -> &mut Self {
		self.inst(IrInst::icall(ea, target.into(), targetn))
	}

	/// TODO: docme
	pub(crate) fn ret(&mut self, ea: EA, target: impl Into<IrSrc>, targetn: i8) -> &mut Self {
