...
pub(super) fn transfer(inst: &IrInst, state: &mut ConstPropState) -> bool {
	use IrInstKind::*;
...
pub(super) fn do_unop(op: IrUnOp, val: u64, src_size: ValSize, dst_size: ValSize) -> u64 {
	use IrUnOp::*;
...
pub(super) fn do_binop(op: IrBinOp, val1: u64, val2: u64, size: ValSize) -> Option<u64> {
	use IrBinOp::*;
...
pub(super) fn do_ternop(op: IrTernOp, val1: u64, val2: u64, val3: u64, size: ValSize) -> u64 {
	use IrTernOp::*;
