...
const NES_STD_NAMES: &[StdName] = &[
	StdName("PPUCTRL",           0x2000),
	StdName("PPUMASK",           0x2001),
	StdName("PPUSTATUS",         0x2002),
	StdName("OAMADDR",           0x2003),
	StdName("OAMDATA",           0x2004),
	StdName("PPUSCROLL",         0x2005),
	StdName("PPUADDR",           0x2006),
	StdName("PPUDATA",           0x2007),

	StdName("APU_PULSE1_CTRL",   0x4000),
	StdName("APU_PULSE1_SWEEP",  0x4001),
	StdName("APU_PULSE1_TIMER",  0x4002),
	StdName("APU_PULSE1_LEN",    0x4003),
	StdName("APU_PULSE2_CTRL",   0x4004),
	StdName("APU_PULSE2_SWEEP",  0x4005),
	StdName("APU_PULSE2_TIMER",  0x4006),
	StdName("APU_PULSE2_LEN",    0x4007),
	StdName("APU_TRI_COUNTER",   0x4008),
	StdName("APU_TRI_TIMER",     0x400A),
	StdName("APU_TRI_LEN",       0x400B),
	StdName("APU_NOISE_CTRL",    0x400C),
	StdName("APU_NOISE_PERIOD",  0x400E),
	StdName("APU_NOISE_LEN",     0x400F),
	StdName("APU_DMC_CTRL",      0x4010),
	StdName("APU_DMC_COUNTER",   0x4011),
	StdName("APU_DMC_ADDR",      0x4012),
	StdName("APU_DMC_LEN",       0x4013),
	StdName("OAMDMA",            0x4014),
	StdName("APU_CTRL",          0x4015),
	StdName("JOY1",              0x4016),
	StdName("JOY2_FRAMECTR",     0x4017),
	// TODO: have these enabled through some platform option
	// StdName("TEST_PULSE_DAC",    0x4018),
	// StdName("TEST_TRINOISE_DAC", 0x4019),
	// StdName("TEST_DPCM_DAC",     0x401A),
